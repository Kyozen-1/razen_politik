...
@section('title', 'Razen Politik | Landing Page | Bantuan')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title"> Bantuan</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    <li class="breadcrumb-item"><a href="#">Landing Page</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('razen-politik.landing-page.bantuan.index') }}">Bantuan</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            <form action="{{ route('razen-politik.landing-page.bantuan.store.section-1') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3 position-relative form-group">
                            ...
                            @if ($section_1)
                            <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_1['gambar']) }}" required>
                            @else
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            {{-- Form Start --}}
            <form action="{{ route('razen-politik.landing-page.bantuan.store.section-2') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="mb-3 position-relative form-group">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3 position-relative form-group">
                            ...
                            @if ($section_2)
                            <input type="file" class="dropify" name="gambar_1" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_2['gambar_1']) }}" required>
                            @else
                        ...
                        <div class="mb-3 position-relative form-group">
                            ...
                            @if ($section_2)
                            <input type="file" class="dropify" name="gambar_2" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_2['gambar_2']) }}" required>
                            @else
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            {{-- Form Start --}}
            <form action="{{ route('razen-politik.landing-page.bantuan.store.section-3') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="mb-3 position-relative form-group">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Gambar Background 1</label>
                            @if ($section_3)
                            <input type="file" class="dropify" name="gambar_background_1" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_3['gambar_background_1']) }}" required>
                            @else
                            <input type="file" class="dropify" name="gambar_background_1" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                            @endif
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Gambar Background 2</label>
                            @if ($section_3)
                            <input type="file" class="dropify" name="gambar_background_2" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_3['gambar_background_2']) }}" required>
                            @else
                            <input type="file" class="dropify" name="gambar_background_2" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                            @endif
                        </div>
                        <div class="mb-3 position-relative form-group">
                            <label for="" class="form-label">Gambar</label>
                            @if ($section_3)
                            <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/razen-politik/bantuan/'.$section_3['gambar']) }}" required>
                            @else
                            <input type="file" class="dropify" name="gambar" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" required>
                            @endif
                        </div>
    ...
    <div class="card mb-5">
        <div class="card-body">
            ...
            {{-- Form Start --}}
            <form action="{{ route('razen-politik.landing-page.bantuan.store.section-4') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        <div class="mb-3 position-relative form-group">
