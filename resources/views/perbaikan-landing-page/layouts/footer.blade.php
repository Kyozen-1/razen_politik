<!-- footer area start -->
<footer class="footer-area line-bg" style="background-image: url({{asset('landing-page/assets/img/line.png')}});">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="footer-widget widget">
                ...
                <a href="index.html" class="footer-logo"> <img src="{{ asset('landing-page/assets/img/footer-logo.png') }}" alt="footer logo"></a>
            ...
            <div class="footer-widget widget widget_subscribe subscribe-bg"
                style="background-image: url({{asset('landing-page/assets/img/Mask-flag.png')}});">
                ...
                <div class="btn-wrapper">
                    <a href="#" class="boxed-btn btn-sanatory style-03">Subscribe Now <i class="icon-paper-plan"></i></a>
                </div>
                </form>
            </div>
            </div>
