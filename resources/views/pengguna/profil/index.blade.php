...
@section('content')
    ...
    <div class="card mb-3">
        <div class="card-body">
            <form action="{{ route('pengguna.profil.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row mb-3">
                ...
                <div class="row">
                    <div class="col-md-8 col-12">
                        ...
                        <div class="form-group position-relative mb-3">
                            ...
                            <input type="text" class="form-control" id="no_hp" name="no_hp" value="{{$pengguna->no_hp}}" required>
                        </div>
                        <div class="form-group position-relative mb-3">
                            <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                            <select name="jenis_kelamin" id="jenis_kelamin" class="form-control" required>
                                <option value="L" @if($pengguna->jenis_kelamin == 'L') selected @endif>Laki - Laki</option>
                                <option value="P" @if($pengguna->jenis_kelamin == 'P') selected @endif>Perempuan</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4 col-12">
                        <div class="form-group position-relative mb-3">
                            ...
                            <input type="file" class="dropify" name="foto" id="foto" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/pengguna/'.$pengguna->foto) }}" required>
                        </div>
                    </div>
                    <div class="col-12">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3 position-relative form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" rows="5" class="form-control" required>{{$pengguna->alamat}}</textarea>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 position-relative form-group">
                                    <label for="rt" class="form-label">RT</label>
                                    <input type="text" class="form-control" id="rt" name="rt" placeholder="ex: 001" value="{{$pengguna->rt}}" required>
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="mb-3 position-relative form-group">
                                    <label for="rw" class="form-label">RW</label>
                                    <input type="text" class="form-control" id="rw" name="rw" placeholder="ex: 001" value="{{$pengguna->rt}}" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card mb-3">
        <div class="card-body">
            ...
            @endif
            <form action="{{ route('pengguna.profil.ganti-password') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
...
@section('js')
    ...
    <script>
        var state_kabupaten_kota_id = "{{$pengguna->kabupaten_kota_id}}";
        var state_kecamatan_id = "{{$pengguna->kecamatan_id}}";
        var state_kelurahan_id = "{{$pengguna->kelurahan_id}}";
        ...
        $(document).ready(function(){
            ...
            $("[name='provinsi_id']").val("{{$pengguna->provinsi_id}}").trigger('change');
        });
