...
<title>@yield('title', 'Dashboard | Relawan')</title>
<meta name="description" content="Admin Panel Razen Politik" />
<!-- Favicon Tags Start -->
...
<link rel="icon" type="image/png" href="{{ asset('images/razen-politik/logo/'.$profil->logo_kecil) }}" sizes="196x196" />
<link rel="icon" type="image/png" href="{{ asset('images/razen-politik/logo/'.$profil->logo_kecil) }}" sizes="96x96" />
<link rel="icon" type="image/png" href="{{ asset('images/razen-politik/logo/'.$profil->logo_kecil) }}" sizes="32x32" />
<link rel="icon" type="image/png" href="{{ asset('images/razen-politik/logo/'.$profil->logo_kecil) }}" sizes="16x16" />
<link rel="icon" type="image/png" href="{{ asset('images/razen-politik/logo/'.$profil->logo_kecil) }}" sizes="128x128" />
