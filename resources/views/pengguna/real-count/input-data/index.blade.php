...
@section('title', 'Input Data | Real Count | Pengguna')
...
<div class="page-title-container">
    ...
    <div class="col-12 col-md-7">
        <h1 class="mb-0 pb-0 display-4" id="title">Input Data | Real Count</h1>
        <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
            <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="#">Input Data</a></li>
                <li class="breadcrumb-item"><a href="#">Real Count</a></li>
            </ul>
        </nav>
    </div>
    <!-- Title End -->
