...
@section('title', 'Penerimaan Barang | Logistik | Pengguna')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Penerimaan Barang</h1>
    ...
    <div class="data-table-rows slim">
        ...
        <div class="data-table-responsive-wrapper">
            <table id="logistik_penerimaan_table" class="data-table w-100">
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12">
                            ...
                            <div class="form-group position-relative mb-3">
                                <label for="detail_tgl_terima" class="form-label">Tanggal Terima</label>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            ...
            var dataTables = $('#logistik_penerimaan_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('pengguna.logistik.penerimaan.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
        ...
        $(document.body).on('click', '.detail', function(){
            var id = $(this).attr('id');
            var url = "{{ route('pengguna.logistik.penerimaan.show', ['id' => ":id"]) }}";
