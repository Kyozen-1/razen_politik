...
@section('title', 'Data Pemilih | Koordinator')
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" action="{{ route('koordinator.data-pemilih.impor') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
    ...
    <script>
        $(document).ready(function(){
            ...
            function data_pemilih_datatable(provinsi_id = '', kabupaten_kota_id = '', kecamatan_id = '', kelurahan_id = '', dapil_id = '')
            {
                var dataTables = $('#dpt_table').DataTable({
                    ...
                    serverSide: true,
                    ajax: {
                        url: "{{ route('koordinator.data-pemilih.index') }}",
                        data: {
        ...
        $('#kecamatan_id').on('change', function(){
            if($(this).val() != '')
            {
                ...
                $.ajax({
                    url: "{{ route('koordinator.data-dpt.get-data-dapil') }}",
                    method: 'POST',
                    data:{
                        "_token": "{{ csrf_token() }}",
        ...
        $(document.body).on('click', '.detail', function(){
            var id = $(this).attr('id');
            var url = "{{ route('koordinator.data-pemilih.show', ['id' => ":id"]) }}";
        ...
        $('#ok_button').click(function(){
            var url = "{{ route('koordinator.data-pemilih.destroy', ['id' => ":user_id"]) }}";
