@extends('auth.razen-politik.layouts.app')
    ...
    <div class="col-12 col-lg-auto h-100 pb-4 px-4 pt-0 p-lg-0">
        ...
        <div class="sw-lg-50 px-5">
            ...
            <a href="{{ route('beranda') }}">
                ...
                <img src="{{ asset('images/razen-politik/logo/642b9aa063e73-230404.png') }}" alt="logo" style="height: 5rem;"/>
            </a>
            </div>
            <div class="mb-5">
            ...
            <div>
            <form action="{{ route('razen-politik.login.submit') }}" method="POST" class="tooltip-end-bottom" novalidate>
                @csrf
