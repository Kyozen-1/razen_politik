...
<div class="data-table-rows slim">
    ...
    <div class="data-table-responsive-wrapper">
        <table id="rekapitulasi_pemilih_pendukung_table" class="data-table w-100">
            <thead>
                <tr>
                    <th>No</th>
                    <th>Provinsi</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#rekapitulasi_pemilih_pendukung_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: {
                    url: "{{ route('pengguna.rekapitulasi.pemilih-pendukung.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
