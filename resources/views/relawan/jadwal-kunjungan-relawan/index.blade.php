...
@section('title', 'Jadwal Kunjungan Relawan | Relawan')
    ...
    <div class="col-12 col-md-7">
        ...
        <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
            <ul class="breadcrumb pt-0">
                <li class="breadcrumb-item"><a href="{{ route('relawan.jadwal-kunjungan-relawan.index') }}">Jadwal Kunjungan Relawan</a></li>
            </ul>
        </nav>
    </div>
    <!-- Title End -->
    ...
    <script>
        $(document).ready(function(){
            var dataTables = $('#jadwal_kunjungan_relawan_table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('relawan.jadwal-kunjungan-relawan.index') }}"
                },
                columns: [
                    {
                        data: 'DT_RowIndex',
