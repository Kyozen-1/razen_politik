...
class ProfilController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('razen-politik.admin.profil.index', [
            'profil' => $profil,
    ...
    public function store(Request $request)
    {
        ...
        if($request->logo)
        {
            File::delete(public_path('images/razen-politik/logo/'.$profil->logo));

            $logoExtension = $request->logo->extension();
            $logoName =  uniqid().'-'.date("ymd").'.'.$logoExtension;
            $logo = Image::make($request->logo);
            $logoSize = public_path('images/razen-politik/logo/'.$logoName);
        ...
        if($request->logo_kecil)
        {
            File::delete(public_path('images/razen-politik/logo/'.$profil->logo_kecil));
            ...
            $logoKecilSize = public_path('images/razen-politik/logo/'.$logoKecilName);
        ...
        return redirect()->route('razen-politik.admin.profil.index');
    }
