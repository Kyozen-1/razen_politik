...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('laporan_isus', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreignId('jenis_isu_id')->nullable();
            $table->foreign('jenis_isu_id')->references('id')->on('master_jenis_isus')->onDelete('cascade');
            ...
            $table->dateTime('tgl_ditanggapi')->nullable();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('laporan_isus');
    }
};
